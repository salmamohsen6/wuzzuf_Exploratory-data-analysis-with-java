...
public class Services {
    ...
    POJO companyOffers = wuzzufDao.countJobs();
    Dataset<Row> companyOffersDataset = companyOffers.getDataset();
    POJO mostPopJobs = wuzzufDao.mostPopularJobs();
    Dataset<Row> mostPopJobsDataset = mostPopJobs.getDataset();
    POJO mostPopAreas = wuzzufDao.mostPopularAreas();
    Dataset<Row> mostPopAreasDataset = mostPopAreas.getDataset();
    POJO mostPopSkills = wuzzufDao.mostPopularSkills();
    Dataset<Row> mostPopSkillsDataSet = mostPopSkills.getDataset();
